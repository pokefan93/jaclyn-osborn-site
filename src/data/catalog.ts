...
export const series: Series[] = [
  {
    ...
    description:
      'Celestial politics, dangerous protectors, and tenderness that keeps surviving the impossible. Each book follows a new couple within the same world.',
    status: 'Ongoing',
    entryPoint: 'Galen',
  ...
  },
  {
    ...
    description:
      'A softer supernatural space: small-town community, comforting atmosphere, and romance that glows rather than broods.',
    status: 'Ongoing',
  ...
  },
  {
    ...
    description:
      'Contemporary M/M romance with emotional depth, strong chemistry, and relationship arcs built on care.',
    status: 'Complete',
  ...
  },
  {
    ...
    description:
      'Harbor towns, emotional recovery, and characters building safer futures without losing the heat.',
    status: 'Ongoing',
  ...
  },
  {
    ...
    description:
      'Royal stakes, destiny mechanics, and romance that has to fight against the shape of history.',
    status: 'Complete',
